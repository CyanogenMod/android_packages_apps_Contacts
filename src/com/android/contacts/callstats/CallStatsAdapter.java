...
class CallStatsAdapter extends ArrayAdapter<CallStatsDetails>
    ...
    private long mTotalCallCount = 0;
    ...
    public String getTotalCallCountString() {
        return CallStatsDetailHelper.getCallCountString(mContext, mTotalCallCount);
    }

    public String getFullDurationString() {
        switch (mType) {
            case CallStatsQueryHandler.CALL_TYPE_ALL:
                return CallStatsDetailHelper.getDurationString(mContext, mFullDuration);
            case Calls.INCOMING_TYPE:
                return CallStatsDetailHelper.getDurationString(mContext, mFullInDuration);
            case Calls.OUTGOING_TYPE:
                return CallStatsDetailHelper.getDurationString(mContext, mFullOutDuration);
            case Calls.MISSED_TYPE:
                return CallStatsDetailHelper.getCallCountString(mContext, mTotalMissedCount);
        }
