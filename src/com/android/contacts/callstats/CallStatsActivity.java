...
public class CallStatsActivity extends ListActivity implements
        ...
        public void onDateSet(long from, long to) {
            if (to < from) {
                Toast toast = Toast.makeText(mContext,
                        getActivity().getString(R.string.call_stats_filter_error),
                        Toast.LENGTH_SHORT);
                toast.show();
            } else {
                mFilterFrom = from;
    ...
    public void onCreate(Bundle state) {
        ...
        mAdapter = new CallStatsAdapter(this,
                new ContactInfoHelper(this, currentCountryIso), mList);
    ...
    private void updateHeader() {
        mSumHeaderView.setText(getString(R.string.call_stats_header_total,
                mAdapter.getTotalCallCountString(), mAdapter.getFullDurationString(false)));
